...
import { enforceChunkCharLimit, splitIntoChunksByStrategy } from './notebookChunking.js';
        ...
        if (job.job_type === 'delete' || !item.is_indexable) {
            ...
            const rawChunks = extractedList.flatMap((extracted) => {
                ...
                return segmentList.flatMap((segment) => {
                    const sourceChunks = splitIntoChunksByStrategy(segment.text, jobChunkStrategy, jobChunkSize, jobChunkSeparator);
